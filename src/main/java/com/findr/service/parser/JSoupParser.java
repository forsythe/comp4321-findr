...
//                result.setSize(result.getBody().length());
    ...
    private static Collection<String> getLinks(Document doc, String baseURL) {
        ...
        */
        ...
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".xlsm"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".rar"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".tgz"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".tar"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".java"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".xpi"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".mp4"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".m4v"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".mov"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".gif"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".swf"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".ps"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".pl"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".r"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".apk"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".svg"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".jar"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".pps"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".exe"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".gz"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".flw"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".flv"))	
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".msi"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".dmg"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".ps.z"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".cer"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".scala"))
        .filter(x -> !x.attr("href").toLowerCase().endsWith(".ai"))
